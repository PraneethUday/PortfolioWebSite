  ...
  return (
    <header className="header">
      <div className="hero-section">
        ...
        <p className="title-text">3rd-year CSE student | Embedded Systems & Web Developer</p>
        <div className="social-links">
          <a href="https://github.com/PraneethUday" target="_blank" rel="noopener noreferrer" className="social-link">
          ...
          <a href="https://www.linkedin.com/in/praneeth-u-615959314/" target="_blank" rel="noopener noreferrer" className="social-link">
            <svg className="icon" viewBox="0 0 24 24" fill="currentColor">
